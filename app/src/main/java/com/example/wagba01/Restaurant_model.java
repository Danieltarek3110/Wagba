...
/*
    ...
    ArrayList<Dishes_Model> Papa = new ArrayList<Dishes_Model>();
    Papa.add(new Dishes_Model("Chicken Ranch Small" , "120" , 9));
    Papa.add(new Dishes_Model("Chicken Ranch Medium" , "240" , 10));
    Papa.add(new Dishes_Model("Chicken Ranch Large" , "290" , 11));
    Papa.add(new Dishes_Model("Chicken Ranch Family" , "320" , 12));

    ArrayList<Dishes_Model> BKing = new ArrayList<Dishes_Model>();
    BKing.add(new Dishes_Model("Whooper" , "120" , 13));
    BKing.add(new Dishes_Model("Double Whooper" , "240" , 14));
    BKing.add(new Dishes_Model("Triple Whooper" , "290" , 15));
    BKing.add(new Dishes_Model("Quadriple Whooper" , "320" , 16));

    ArrayList<Dishes_Model> Starbucks = new ArrayList<Dishes_Model>();
    Starbucks.add(new Dishes_Model("Esperesso" , "20" , 17));
    Starbucks.add(new Dishes_Model("Latte" , "40" , 18));
    Starbucks.add(new Dishes_Model("Tea" , "90" , 19));
    Starbucks.add(new Dishes_Model("American Coffee" , "120" , 20));
