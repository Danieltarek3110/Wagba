...
public class Restaurants extends AppCompatActivity {
    ...
    private void SetUpRestaurantModels(){
       ...
       // SetUpDishesModel();
        ...
        kfc_menu.add(new Dishes_Model("Mighty Zinger" , "EGP120" , dishesImages[0] ));
        kfc_menu.add(new Dishes_Model("Dinner Box" , "EGP80" , dishesImages[1] ));
        kfc_menu.add(new Dishes_Model("Twister" , "EGP100" , dishesImages[2] ));
        kfc_menu.add(new Dishes_Model("Rizo" , "EGP60" , dishesImages[3] ));
        ...
        mac_menu.add(new Dishes_Model("Macdo" , "120EGP" , dishesImages[4]));
        mac_menu.add(new Dishes_Model("ShareBox" , "240EGP" , dishesImages[5]));
        mac_menu.add(new Dishes_Model("Big Tasty" , "100EGP" , dishesImages[6]));
        mac_menu.add(new Dishes_Model("Big Mac" , "80EGP" , dishesImages[7]));
        ...
        Papa_menu.add(new Dishes_Model("Chicken Ranch Small" , "120" , dishesImages[8]));
        Papa_menu.add(new Dishes_Model("Chicken Ranch Medium" , "240" , dishesImages[9]));
        ...
        BKing_menu.add(new Dishes_Model("Quadriple Whooper" , "320" , dishesImages[15]));
        ...
        Starbucks_menu.add(new Dishes_Model("Esperesso" , "20" , dishesImages[16]));
        Starbucks_menu.add(new Dishes_Model("Latte" , "40" , dishesImages[17]));
        Starbucks_menu.add(new Dishes_Model("Tea" , "90" , dishesImages[18]));
        Starbucks_menu.add(new Dishes_Model("American Coffee" , "120" , dishesImages[19]));
        ...
        Sizzler.add(new Dishes_Model("Medium" , "190" , dishesImages[22]));
        ...
        Costa.add(new Dishes_Model("Turkish Coffee" , "120" , dishesImages[28]));
        Costa.add(new Dishes_Model("American Coffee" , "140" , dishesImages[29]));
        Costa.add(new Dishes_Model("Water" , "190" , dishesImages[30]));
        Costa.add(new Dishes_Model("Juice" , "220" , dishesImages[31]));
        ...
        Hut.add(new Dishes_Model("Seafood Pizza" , "220" , dishesImages[35]));
        ...
        Attack.add(new Dishes_Model("Ham Burger" , "220" , dishesImages[39]));
